...
const navigation = computed(() => [
  ...
  { name: 'PostgreSQL', href: '/databases', icon: TableCellsIcon, current: route.path.startsWith('/databases') },
  { name: 'MySQL', href: '/mysql', icon: TableCellsIcon, current: route.path.startsWith('/mysql') },
