...
def list_directory(
    ...
    for root in ALLOWED_ROOTS:
        # Check for exact match or subdirectory (ensure trailing slash to prevent partial matches like /tmp-secret)
        if clean_path == root or clean_path.startswith(os.path.join(root, "")):
            is_allowed = True
            break
